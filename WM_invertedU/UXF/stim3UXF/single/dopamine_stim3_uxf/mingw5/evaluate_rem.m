...
Fe1_st_when(num)=mean(data4(n_nostim:not_count_T,7));

Fe1_st_aft(num)=mean(data4(not_count_T:life/TCamp,7));
Fe1_st_pre(num)=mean(data4(1:n_nostim,7));
...
subplot(1,4,3);
plot(xx,u_st_end,'-');
% title('u when stim end','FontWeight','demi','FontSize',12);
...
subplot(1,4,2);
plot(xx,x_st_end,'-');
% title('x when stim end','FontWeight','demi','FontSize',12);
xlabel('dopamine D ','FontWeight','demi','FontSize',12); 
...
subplot(1,4,4);
plot(xx,ux_st_end,'-');
% title('ux when stim end','FontWeight','demi','FontSize',12);
xlabel('dopamine D','FontWeight','demi','FontSize',12); 
...
subplot(1,4,1);
plot(xx,Fe1_st_when,'-');
% title('E1 rate during stim','FontWeight','demi','FontSize',12);
xlabel('dopamine D','FontWeight','demi','FontSize',12); 
ylabel('rate [Hz]','FontWeight','demi','FontSize',12);
% hold on;line([D1_refer,D1_refer],[0,40],'color','r','line','--');hold off;
ylim([0,40]);

figure();
plot(xx,Fe1_st_pre,'o-',xx,Fe1_st_when,'o-',xx,Fe1_st_aft,'o-');legend('pre','dur','aft');
...
% subplot(2,2,1); 
% plot(xx,x_train,'o-');
% title('x_{memory}','FontWeight','demi','FontSize',12);
% xlabel(['D1','(muEext=',num2str(muEext), ')'],'FontWeight','demi','FontSize',12); 
% ylabel('x','FontWeight','demi','FontSize',12);
% xlim([0,2]);%ylim([0,1]); 
% subplot(2,2,2);
% plot(xx,u_train,'o-');
% title('u_{memory}','FontWeight','demi','FontSize',12);
% xlabel(['D1','(muEext=',num2str(muEext), ')'],'FontWeight','demi','FontSize',12); 
% ylabel('u','FontWeight','demi','FontSize',12);
% xlim([0,2]);%ylim([0,1]);
% subplot(2,2,3);
...
% ylabel('ux','FontWeight','demi','FontSize',12);
% xlabel(['D1','(muEext=',num2str(muEext), ')'],'FontWeight','demi','FontSize',12); 
% title('ux_{memory}','FontWeight','demi','FontSize',12);
% xlim([0,2]);%ylim([0,1]);
% subplot(2,2,4);
% plot(xx,n_T,'o-');
