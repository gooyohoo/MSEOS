...
float Tprestim_PT=1000, Tcue_PT=0, Tdelay_PT=3000;	 
...
while(D1>=154) 
{
  //De=((1+0.2/(1+exp((0.8-D1/100)/0.25)))*ce-0.9)*100;
 //Di=((1+0.2/(1+exp((1.2-D1/100)/0.25)))*ci-0.9)*100;			
	De=D1;
	Di=125;
