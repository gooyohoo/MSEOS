...
D1=140;%contrast factor of connection strength
windw=0.28;% time bin
pr=1;%the part of neurons to count in
TPicEnd=4000;%all time for picture u,x,firrate,cluster
TPLawEnd=30000;TPLawBegin=10000;% time preiod for caculate Power law
...
figure();
[CC,expect,slope]=find_Power_Law(raster,windw,life,Ne,pr,f,D1,data1 )
grid off;
% num=num+1;
